...
- **Priority** — An optional High, Medium, or Low marker, set from the task's context menu or for several selected tasks at once. Task lists can sort and filter by it. See [[4.07b-Tags_Ordinal-Priorities]] for using tags when you need more levels.
