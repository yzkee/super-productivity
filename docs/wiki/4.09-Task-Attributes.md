...
- **Subtasks** — A task can have subtasks; the app stores the list of subtask IDs so parent and child tasks stay linked.
...
- **Parent task** — For subtasks, the link back to the parent so the app can show hierarchy and aggregate time or completion.
...
- **Notes** — Additional text you attach to the task.
