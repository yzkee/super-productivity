# Obsidian Linter Config (YAML)

 This config is for the [Linter plugin](https://platers.github.io/obsidian-linter/) for Obsidian. It will match the [[0.01-Style-Guide]].
