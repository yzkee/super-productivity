...
If you encounter problems, see [this issue comment](https://github.com/super-productivity/super-productivity/issues/3193#issuecomment-2131315513).

### Wayland (Linux)

If you use Wayland and see rendering problems, VSync errors, or GLib-GObject warnings, see [[3.99-Other]] for the `--force-x11` option.
...
You can also install from the [App Store](https://apps.apple.com/app/super-productivity/id1482572463?l=en&mt=12).
...
You can find the Android app on [Google Play](https://play.google.com/store/apps/details?id=com.superproductivity.superproductivity) or [F-Droid](https://f-droid.org/en/packages/com.superproductivity.superproductivity).
