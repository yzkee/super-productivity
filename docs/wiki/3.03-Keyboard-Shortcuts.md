...
- `Ctrl+2`: Toggle issue-search mode
- `Ctrl+3`: Open project selector
- `Ctrl+4`: Open schedule dialog (set due date/time)
- `Ctrl+5`: Open tags selector
- `Ctrl+6`: Open estimate selector
- `Ctrl+7`: Open repeat settings
- `Ctrl+8`: Open deadline dialog (set hard deadline)
