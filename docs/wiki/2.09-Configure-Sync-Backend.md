...
**Mobile sync stopped with `AADSTS9002327` after an update:** If you registered the redirect URI as a **Single-page application (SPA)** to get mobile sign-in working, move it to **Mobile and desktop applications**, then sign in to OneDrive again.
