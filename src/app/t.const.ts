const T = {
  ...
  F: {
    ...
    SYNC: {
      ...
      D_DECRYPT_ERROR: {
        ...
        P3_START_OVER: 'F.SYNC.D_DECRYPT_ERROR.P3_START_OVER',
      ...
      S: {
        ...
        DEFERRED_ACTIONS_STUCK: 'F.SYNC.S.DEFERRED_ACTIONS_STUCK',
  ...
  FILE_IMEX: {
    ...
    S_ERR_IMPORT_UNREPAIRABLE: 'FILE_IMEX.S_ERR_IMPORT_UNREPAIRABLE',
